...
} from './studyMaterialStorage.js'

export const FACULTY_MATERIAL_MAX_BYTES = 10 * 1024 * 1024
export const FACULTY_MATERIAL_SIZE_MSG = 'File size must not exceed 10MB.'
...
export function parseBase64Upload(body) {
  ...
  if (m) {
    mimetype = m[1] || mimetype || 'application/pdf'
