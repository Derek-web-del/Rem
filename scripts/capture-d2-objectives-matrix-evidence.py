"""Capture PDF page screenshots for D.2 Specific Objectives Compliance matrix evidence."""
import json
import os
...
OUT_DIR = r"c:\xampp\htdocs\LenLearn\docs\thesis\checklist-evidence\d2"
ZOOM = 2.0

PAGE_MAP = {
    "specific_objectives_so3_so6": 26,
    "methodology_evaluation_plan": 139,
}
...
def main():
    ...
    for key, page in PAGE_MAP.items():
        ...
        manifest[key] = {
            ...
            "file": f"checklist-evidence/d2/{filename}",
        }
