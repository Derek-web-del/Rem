...
function AiListBadge({ report }) {
  if (!report?.aiDetectionRan || report.aiProbability == null) return null
  const style = getAiVerdictStyle(report.aiProbability, report.aiVerdict)
  return (
    <span
