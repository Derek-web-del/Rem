...
export default function TeacherAssignmentView() {
  ...
  const deadlineIso = assignment?.submission_deadline
  ...
  async function handleCheckPlagiarism(sub) {
    ...
    try {
      const report = await checkSubmissionPlagiarism({ kind: 'assignment', itemId: id, submissionId: sub.id })
                                    ...
                                    <ActionBtn
                                      ...
                                      onClick={() =>
                                        setLateSubmissionTarget({
                                          item: { entity_type: 'assignment', entity_id: id, title: assignment.title },
